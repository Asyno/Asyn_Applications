...
namespace CreateExcel_Test
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string path = @"C:\Users\Jan\Desktop\test.xml";

            table.Columns.Add(new DataColumn());
            table.Columns.Add(new DataColumn());

            table.TableName = "TestTable";
            table.Rows.Add(new Object[] { 1, "A1" });
            table.Rows.Add(new Object[] { 2, "A2" });

            SpreadsheetMLHelper.ExportDataTableToWorksheet(table, path);
        }
    }
